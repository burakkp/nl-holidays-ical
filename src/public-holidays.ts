// NL resmi tatiller için kural tabanlı üretim
// Not: Paskalya hesaplaması için Anonymous Gregorian algoritması
export type Holiday = { uid: string; title: string; start: Date; end: Date; allDay?: boolean; location?: string; desc?: string };
...
export function generateNlPublicHolidays(year: number): Holiday[] {
